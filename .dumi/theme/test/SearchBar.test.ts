...
describe('test highlight', () => {
  it('should render right', () => {
    ...
    expect(element1[1].props).toEqual({
    ...
    expect(element2[1].props).toEqual({
      className: '__dumi-default-search-highlight',
      children: '2',
    });
    ...
    expect(element3[1].props).toEqual({
      className: '__dumi-default-search-highlight',
      children: '23',
    });
    ...
    expect(element4[1].props).toEqual({
      className: '__dumi-default-search-highlight',
      children: '34',
    });
    ...
    expect(element5[1].props).toEqual({
      className: '__dumi-default-search-highlight',
      children: '1234',
    });
